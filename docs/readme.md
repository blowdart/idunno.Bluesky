...
* [Changing a user's profile](profileEditing.md)
  * [Pinning a post](profileEditing.md#pinningAPost)
  * [Discouraging apps from showing the account to unauthenticated users](profileEditing.md#discouragingUnauthenticatedViewing)
