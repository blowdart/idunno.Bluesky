...
/// <summary>
/// Represents an error indicating that the specified account was not found.
/// </summary>
public sealed class AccountNotFound : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="AccountNotFound"/>.
    /// </summary>
    ...
    internal AccountNotFound(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "AccountNotFound";
}