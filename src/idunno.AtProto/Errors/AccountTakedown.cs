...
/// <summary>
/// Represents an error indicating that the specified account was taken down.
/// </summary>
public sealed class AccountTakedown : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="AccountTakedown"/>.
    /// </summary>
    ...
    internal AccountTakedown(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "AccountTakedown";
}