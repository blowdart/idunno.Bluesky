...
/// <summary>
/// Represents an error indicating that authentication is required to access a resource or perform an action, or the credentials provided are invalid.
/// </summary>
public sealed class AuthenticationRequired : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="AuthenticationRequired"/>.
    /// </summary>
    ...
    internal AuthenticationRequired(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "AuthenticationRequired";
}