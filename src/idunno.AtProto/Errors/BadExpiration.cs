...
/// <summary>
/// Represents an error indicating that the requested expiration date is not a valid. May be in the past or may be reliant on the requested scopes.
/// </summary>
public sealed class BadExpiration : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="BadExpiration"/>.
    /// </summary>
    ...
    internal BadExpiration(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "BadExpiration";
}