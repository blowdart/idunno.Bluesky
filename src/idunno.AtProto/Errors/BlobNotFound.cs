...
/// <summary>
/// Represents an error indicating that the requested blob was not found.
/// </summary>
public sealed class BlobNotFound : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="BlobNotFound"/>.
    /// </summary>
    ...
    internal BlobNotFound(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "BlobNotFound";
}
