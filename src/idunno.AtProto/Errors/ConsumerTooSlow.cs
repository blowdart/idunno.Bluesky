...
/// <summary>
/// Represents an error indicating that the consumer is too slow. If the consumer of the stream can not keep up with events, and a backlog gets too large, the server will drop the connection.
/// </summary>
public sealed class ConsumerTooSlow : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="ConsumerTooSlow"/>.
    /// </summary>
    ...
    internal ConsumerTooSlow(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "ConsumerTooSlow";
}