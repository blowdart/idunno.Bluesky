...
/// <summary>
/// Represents an error indicating that the specified DID was deactivated.
/// </summary>
public sealed class DidDeactivated : AtProtoError
{
    /// <summary>
    ...
    internal DidDeactivated(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "DidDeactivated";
}