...
/// <summary>
/// Represents an error indicating that a duplicate creation attempt was made.
/// </summary>
public sealed class DuplicateCreate : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="DuplicateCreate"/>.
    /// </summary>
    ...
    internal DuplicateCreate(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "DuplicateCreate";
}