...
/// <summary>
/// Represents an error indicating that the specified token has expired.
/// </summary>
public sealed class ExpiredToken : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="ExpiredToken"/>.
    /// </summary>
    ...
    internal ExpiredToken(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "ExpiredToken";
}