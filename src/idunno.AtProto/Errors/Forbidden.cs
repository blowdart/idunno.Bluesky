...
/// <summary>
/// Represents an error indicating that the request was understood but refused, corresponding to an HTTP 403.
/// </summary>
public sealed class Forbidden : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="Forbidden"/>.
    /// </summary>
    ...
    public Forbidden(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "Forbidden";
}
