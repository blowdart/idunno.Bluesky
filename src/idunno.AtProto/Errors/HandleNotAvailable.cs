...
/// <summary>
/// Represents an error indicating that the specified handle was not available.
/// </summary>
public sealed class HandleNotAvailable : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="HandleNotAvailable"/>.
    /// </summary>
    ...
    internal HandleNotAvailable(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "HandleNotAvailable";
}
