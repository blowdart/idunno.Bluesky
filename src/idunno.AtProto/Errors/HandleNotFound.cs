...
/// <summary>
/// Represents an error indicating that the specified handle was not found.
/// </summary>
public sealed class HandleNotFound : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="DidDeactivated"/>.
    /// </summary>
    ...
    internal HandleNotFound(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "HandleNotFound";
}
