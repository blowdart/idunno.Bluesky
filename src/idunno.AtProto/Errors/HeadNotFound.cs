...
/// <summary>
/// Represents an error indicating that the requested head was not found.
/// </summary>
public sealed class HeadNotFound : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="HeadNotFound"/>.
    /// </summary>
    ...
    internal HeadNotFound(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "HeadNotFound";
}