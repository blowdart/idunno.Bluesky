...
/// <summary>
/// Represents an error indicating that the requested host was banned.
/// </summary>
public sealed class HostBanned : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="HostBanned"/>.
    /// </summary>
    ...
    internal HostBanned(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "HostBanned";
}