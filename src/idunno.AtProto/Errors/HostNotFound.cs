...
/// <summary>
/// Represents an error indicating that the requested host was not found.
/// </summary>
public sealed class HostNotFound : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="HostNotFound"/>.
    /// </summary>
    ...
    internal HostNotFound(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "HostNotFound";
}
