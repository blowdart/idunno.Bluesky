...
/// <summary>
/// Represents an error indicating an incompatible DID document.
/// </summary>
public sealed class IncompatibleDidDoc : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="IncompatibleDidDoc"/>.
    /// </summary>
    ...
    internal IncompatibleDidDoc(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "IncompatibleDidDoc";
}
