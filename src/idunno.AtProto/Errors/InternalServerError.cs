...
/// <summary>
/// Represents an error indicating that the service failed for a reason it did not describe, corresponding to an HTTP 500.
/// </summary>
public sealed class InternalServerError : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="InternalServerError"/>.
    /// </summary>
    ...
    public InternalServerError(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "InternalServerError";
}
