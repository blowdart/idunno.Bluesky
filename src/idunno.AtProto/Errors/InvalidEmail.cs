...
/// <summary>
/// Represents an error indicating an invalid email address.
/// </summary>
public sealed class InvalidEmail : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="InvalidEmail"/>.
    /// </summary>
    ...
    internal InvalidEmail(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "InvalidEmail";
}