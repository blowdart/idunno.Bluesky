...
/// <summary>
/// Represents an error indicating an invalid invite code.
/// </summary>
public sealed class InvalidInviteCode : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="InvalidInviteCode"/>.
    /// </summary>
    ...
    internal InvalidInviteCode(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "InvalidInviteCode";
}