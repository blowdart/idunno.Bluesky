...
/// <summary>
/// Represents an error indicating that the password supplied when creating an account was rejected by the service.
/// </summary>
public sealed class InvalidPassword : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="InvalidPassword"/>.
    /// </summary>
    ...
    public InvalidPassword(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "InvalidPassword";
}
