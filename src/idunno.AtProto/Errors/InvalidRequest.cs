...
/// <summary>
/// Represents an error indicating an invalid request.
/// </summary>
public sealed class InvalidRequest : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="InvalidRequest"/>.
    /// </summary>
    ...
    internal InvalidRequest(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "InvalidRequest";
}