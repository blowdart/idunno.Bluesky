...
/// <summary>
/// Represents an error indicating an invalid swap operation.
/// </summary>
public sealed class InvalidSwap : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="InvalidSwap"/>.
    /// </summary>
    ...
    internal InvalidSwap(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "InvalidSwap";
}