...
/// <summary>
/// Represents an error indicating that the specified token is invalid.
/// </summary>
public sealed class InvalidToken : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="InvalidToken"/>.
    /// </summary>
    ...
    internal InvalidToken(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "InvalidToken";
}