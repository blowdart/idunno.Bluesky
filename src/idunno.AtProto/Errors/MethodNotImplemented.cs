...
/// <summary>
/// Represents an error indicating that the specified method is not implemented.
/// </summary>
public sealed class MethodNotImplemented : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="MethodNotImplemented"/>.
    /// </summary>
    ...
    internal MethodNotImplemented(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "MethodNotImplemented";
}