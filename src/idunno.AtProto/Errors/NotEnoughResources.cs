...
/// <summary>
/// Represents an error indicating that the service does not currently have the resources to answer the request, corresponding to an HTTP 503.
/// </summary>
public sealed class NotEnoughResources : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="NotEnoughResources"/>.
    /// </summary>
    ...
    public NotEnoughResources(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "NotEnoughResources";
}
