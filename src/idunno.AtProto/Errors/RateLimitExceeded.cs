...
/// <summary>
/// Represents an error indicating that the caller has made too many requests and should back off, corresponding to an HTTP 429.
/// </summary>
public sealed class RateLimitExceeded : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="RateLimitExceeded"/>.
    /// </summary>
    ...
    public RateLimitExceeded(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "RateLimitExceeded";
}
