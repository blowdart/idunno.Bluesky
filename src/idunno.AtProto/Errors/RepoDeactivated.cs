...
/// <summary>
/// Represents an error indicating that the requested repository was deactivated.
/// </summary>
public sealed class RepoDeactivated : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="RepoDeactivated"/>.
    /// </summary>
    ...
    internal RepoDeactivated(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "RepoDeactivated";
}