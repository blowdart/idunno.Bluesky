...
/// <summary>
/// Represents an error indicating that the requested repository was not found.
/// </summary>
public sealed class RepoNotFound : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="RepoNotFound"/>.
    /// </summary>
    ...
    internal RepoNotFound(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "RepoNotFound";
}
