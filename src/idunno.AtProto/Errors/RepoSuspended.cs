...
/// <summary>
/// Represents an error indicating that the requested repository was suspended.
/// </summary>
public sealed class RepoSuspended : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="RepoSuspended"/>.
    /// </summary>
    ...
    internal RepoSuspended(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "RepoSuspended";
}
