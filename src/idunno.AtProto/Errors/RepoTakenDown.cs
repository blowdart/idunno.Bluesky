...
/// <summary>
/// Represents an error indicating that the requested repository was taken down.
/// </summary>
public sealed class RepoTakenDown : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="RepoTakenDown"/>.
    /// </summary>
    ...
    internal RepoTakenDown(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "RepoTakendown";
}
