...
/// <summary>
/// Represents an error indicating that the specified token is required.
/// </summary>
public sealed class TokenRequired : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="TokenRequired"/>.
    /// </summary>
    ...
    internal TokenRequired(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "TokenRequired";
}