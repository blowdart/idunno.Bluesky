...
/// <summary>
/// Represents an error indicating that the domain specified is unsupported.
/// </summary>
public sealed class UnsupportedDomain : AtErrorDetail
{
    /// <summary>
    /// Creates a new instance of the <see cref="UnsupportedDomain"/> class.
    /// </summary>
    ...
    internal UnsupportedDomain(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "UnsupportedDomain";
}