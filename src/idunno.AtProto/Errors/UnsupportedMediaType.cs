...
/// <summary>
/// Represents an error indicating that the request body was sent in a media type the service does not accept, corresponding to an HTTP 415.
/// </summary>
public sealed class UnsupportedMediaType : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="UnsupportedMediaType"/>.
    /// </summary>
    ...
    public UnsupportedMediaType(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "UnsupportedMediaType";
}
