...
/// <summary>
/// Represents an error indicating that a service the endpoint depends on failed, corresponding to an HTTP 502.
/// </summary>
public sealed class UpstreamFailure : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="UpstreamFailure"/>.
    /// </summary>
    ...
    public UpstreamFailure(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "UpstreamFailure";
}
