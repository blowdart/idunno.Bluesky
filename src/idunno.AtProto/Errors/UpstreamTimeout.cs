...
/// <summary>
/// Represents an error indicating that a service the endpoint depends on did not answer in time, corresponding to an HTTP 504.
/// </summary>
public sealed class UpstreamTimeout : AtProtoError
{
    /// <summary>
    /// Creates a new instance of the <see cref="UpstreamTimeout"/>.
    /// </summary>
    ...
    public UpstreamTimeout(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "UpstreamTimeout";
}
