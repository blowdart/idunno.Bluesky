...
/// <summary>
/// Represents an error indicating the XPRC is not supported.
/// </summary>
public sealed class XrpcNotSupported : AtErrorDetail
{
    /// <summary>
    /// Creates a new instance of the <see cref="XrpcNotSupported"/> class.
    /// </summary>
    ...
    internal XrpcNotSupported(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "XRPCNotSupported";
}