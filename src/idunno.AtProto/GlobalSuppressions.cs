...
[assembly: SuppressMessage("Design", "CA1008:Enums should have zero value", Justification = "The values are set by the Bluesky session APIS, and none is not a valid value.", Scope = "type", Target = "~T:idunno.AtProto.Server.AccountStatus")]
