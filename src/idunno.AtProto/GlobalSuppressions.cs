...
[assembly: SuppressMessage("Style", "IDE0130:Namespace does not match folder structure", Justification = "Internal class, namespaced to avoid clashing with the Label class and to keep the folder structure much like the api structure.", Scope = "namespace", Target = "~N:idunno.AtProto.LabelModels")]
