...
namespace idunno.AtProto.Repo
{
    ...
    internal sealed record CreateRecordRequest
    {
        ...
        /// <param name="record">The <see cref="TypedAtProtoRecord"/> to be created.</param>
        ...
        /// <summary>
        /// Gets or sets the DID of the repo the <see cref="TypedAtProtoRecord"/> should be created in in.
        /// </summary>
        /// <value>
        /// The DID of the repo the <see cref="TypedAtProtoRecord"/> should be created in.
        /// </value>
        [JsonRequired]
        public Did Repo { get; set; }

        /// <summary>
        /// Gets or sets the optional record key for the <see cref="TypedAtProtoRecord"/>.
        /// </summary>
        /// <value>
        /// The optional record key for the <see cref="TypedAtProtoRecord"/>.
        /// </value>
