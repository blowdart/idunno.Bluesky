...
namespace idunno.Bluesky.Actions.Model
{
    ...
    /// </summary>
    public sealed record NewLikeRecord
    {
        /// <summary>
        /// Creates a new instance of <see cref="NewLikeRecord"/>.
        /// </summary>
        ...
        public NewLikeRecord(StrongReference subject, DateTimeOffset? createdAt = null)
        {
            Subject = subject;
