...
public record SavedFeedsPreference(
    [property: JsonRequired] ICollection<AtUri> Saved,
    [property: JsonRequired] ICollection<AtUri> Pinned,
    int? TimelineIndex) : Preference
{
}