...
{
    /// <summary>
    /// Creates or updates the preferences for the requesting account.
    /// </summary>
    /// <param name="preferences">The preferences to create or update</param>
    ...
    /// <exception cref="ArgumentNullException">Thrown when any of <paramref name="preferences"/>, <paramref name="service"/>,<paramref name="accessCredentials"/> or <paramref name="httpClient"/> are <see langword="null"/>.</exception>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        BlueskyHttpClient<EmptyResponse> client = new(AppViewProxy, loggerFactory) { MaximumResponseSize = maximumResponseSize };
