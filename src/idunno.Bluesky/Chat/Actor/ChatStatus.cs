...
public sealed record ChatStatus([property: JsonRequired] bool ChatDisabled, [property: JsonRequired] bool CanCreateGroups, [property: JsonRequired] int GroupMemberLimit)
{
}