...
/// </summary>
public sealed record IncomingJoinRequest : LogBase
{
    /// <summary>
    /// Constructs a new instance of <see cref="IncomingJoinRequest"/>.
    /// </summary>
    ...
    [JsonConstructor]
    internal IncomingJoinRequest(string conversationId, string revision, ProfileViewBasic member) : base(conversationId, revision)
    {
        Member = member;
    }
