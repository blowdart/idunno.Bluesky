...
public static partial class BlueskyServer
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        BlueskyHttpClient<MessageView> client = new(ChatProxy, loggerFactory) { MaximumResponseSize = maximumResponseSize };

        SendMessageRequest request = new(conversationId, message);
