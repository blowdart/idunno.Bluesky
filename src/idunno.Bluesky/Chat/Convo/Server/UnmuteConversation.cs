...
public static partial class BlueskyServer
{
    ...
    /// Thrown when <paramref name="conversationId"/> is <see langword="null"/> or empty.
    /// </exception>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        BlueskyHttpClient<ConversationResponse> client = new(ChatProxy, loggerFactory) { MaximumResponseSize = maximumResponseSize };

        ConversationIdPostRequest request = new(conversationId);
