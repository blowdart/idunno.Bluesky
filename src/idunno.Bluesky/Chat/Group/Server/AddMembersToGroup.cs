...
public partial class BlueskyServer
{
    ...
    /// </summary>
    /// <param name="conversationId">The id of the conversation to add members to.</param>
    /// <param name="members">The <see cref="Did"/>s of the members to add to the conversation.</param>
    ...
    [UnconditionalSuppressMessage("AOT",
        ...
        Justification = "All types are preserved in the JsonSerializerOptions call to Post().")]
    public static async Task<AtProtoHttpResult<AddMembersResponse>> AddMembersToGroup(
