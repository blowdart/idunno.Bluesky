...
public partial class BlueskyServer
{
    ...
    [UnconditionalSuppressMessage("AOT",
        ...
        Justification = "All types are preserved in the JsonSerializerOptions call to Post().")]
    public static async Task<AtProtoHttpResult<DisableJoinLinkResponse>> DisableJoinGroupLink(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        BlueskyHttpClient<DisableJoinLinkResponse> client = new(ChatProxy, loggerFactory) { MaximumResponseSize = maximumResponseSize };
