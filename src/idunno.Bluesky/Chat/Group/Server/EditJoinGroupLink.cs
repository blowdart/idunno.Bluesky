...
public partial class BlueskyServer
{
    ...
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="conversationId"/>, <paramref name="joinRule"/>, <paramref name="service"/>, <paramref name="accessCredentials"/> or <paramref name="httpClient"/> is <see langword="null"/>.</exception>
    ...
    [UnconditionalSuppressMessage("AOT",
        ...
        Justification = "All types are preserved in the JsonSerializerOptions call to Post().")]
    public static async Task<AtProtoHttpResult<EditJoinLinkResponse>> EditJoinGroupLink(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        BlueskyHttpClient<EditJoinLinkResponse> client = new(ChatProxy, loggerFactory) { MaximumResponseSize = maximumResponseSize };
