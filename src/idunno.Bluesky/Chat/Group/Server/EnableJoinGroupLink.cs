...
{
    /// <summary>
    /// Enable the join link for a group.
    /// </summary>
    ...
    [UnconditionalSuppressMessage("AOT",
        ...
        Justification = "All types are preserved in the JsonSerializerOptions call to Post().")]
    public static async Task<AtProtoHttpResult<EnableJoinLinkResponse>> EnableJoinGroupLink(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        BlueskyHttpClient<EnableJoinLinkResponse> client = new(ChatProxy, loggerFactory) { MaximumResponseSize = maximumResponseSize };

        AtProtoHttpResult<EnableJoinLinkResponse> response = await client.Post(
            service,
            "/xrpc/chat.bsky.group.enableJoinLink",
            new EnableJoinLinkRequest(conversationId),
