...
public partial class BlueskyServer
{
    ...
    [UnconditionalSuppressMessage("AOT",
        ...
        Justification = "All types are preserved in the JsonSerializerOptions call to Post().")]
    public static async Task<AtProtoHttpResult<EmptyResponse>> RejectJoinGroupRequest(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        BlueskyHttpClient<EmptyResponse> client = new(ChatProxy, loggerFactory) { MaximumResponseSize = maximumResponseSize };
