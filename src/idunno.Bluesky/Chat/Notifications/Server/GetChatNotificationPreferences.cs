...
public static partial class BlueskyServer
{
    ...
    [UnconditionalSuppressMessage("AOT",
        ...
        Justification = "All types are preserved in the JsonSerializerOptions call to Post().")]
    public static async Task<AtProtoHttpResult<Chat.Notifications.Preferences>> GetChatNotificationPreferences(
        Uri service,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        BlueskyHttpClient<Chat.Model.GetPreferencesResponse> client = new(ChatProxy, loggerFactory) { MaximumResponseSize = maximumResponseSize };
