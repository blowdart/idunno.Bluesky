...
/// <summary>
/// Represents an error that occurs when an account is suspended.
/// </summary>
public sealed class AccountSuspended : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="AccountSuspended"/>.
    /// </summary>
    ...
    public AccountSuspended(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "AccountSuspended";
}
