...
/// <summary>
/// Represents an error that occurs when the advisory declared dimensions have an unsupported aspect ratio during multipart video uploads.
/// </summary>
public sealed class BadAspectRatio : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="BadAspectRatio"/>.
    /// </summary>
    ...
    public BadAspectRatio(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "BadAspectRatio";
}