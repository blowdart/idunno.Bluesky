...
/// <summary>
/// Represents an error that occurs when a bad query string is encountered.
/// </summary>
public sealed class BadQueryString : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="BadQueryString"/>.
    /// </summary>
    ...
    public BadQueryString(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "BadQueryString";
}