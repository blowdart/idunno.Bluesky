...
/// <summary>
/// Represents an error indicating that the actor is blocked.
/// </summary>
public sealed class BlockedActor : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="BlockedActor"/>.
    /// </summary>
    ...
    public BlockedActor(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "BlockedActor";
}