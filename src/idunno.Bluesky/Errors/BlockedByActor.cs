...
/// <summary>
/// Represents an error indicating that the actor whose content was requested has blocked the calling account. This is the opposite direction to <see cref="BlockedActor"/>, which reports that the calling account has blocked the actor.
/// </summary>
public sealed class BlockedByActor : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="BlockedByActor"/>.
    /// </summary>
    ...
    public BlockedByActor(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "BlockedByActor";
}
