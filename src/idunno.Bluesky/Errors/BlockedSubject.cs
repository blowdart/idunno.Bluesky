...
/// <summary>
/// Represents an error indicating that the subject is blocked.
/// </summary>
public sealed class BlockedSubject : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="BlockedSubject"/>.
    /// </summary>
    ...
    public BlockedSubject(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "BlockedSubject";
}