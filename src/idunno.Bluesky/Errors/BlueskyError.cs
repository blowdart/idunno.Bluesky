...
public abstract class BlueskyError : AtErrorDetail
{
    ...
    public static AtErrorDetail? Map(AtErrorDetail? atErrorDetail)
    {
        ...
        return atErrorDetail.Error switch
        {
            ...
            ActorNotFound.ErrorTitle => new ActorNotFound(atErrorDetail),
            BadAspectRatio.ErrorTitle => new BadAspectRatio(atErrorDetail),
            BadQueryString.ErrorTitle => new BadQueryString(atErrorDetail),
            BlockedActor.ErrorTitle => new BlockedActor(atErrorDetail),
            BlockedByActor.ErrorTitle => new BlockedByActor(atErrorDetail),
            ...
            ConvoLockedByModeration.ErrorTitle => new ConvoLockedByModeration(atErrorDetail),
            ...
            InvalidJoinRequest.ErrorTitle => new InvalidJoinRequest(atErrorDetail),
            InvalidPartNumber.ErrorTitle => new InvalidPartNumber(atErrorDetail),
            LinkAlreadyEnabled.ErrorTitle => new LinkAlreadyEnabled(atErrorDetail),
            ...
            NotFound.ErrorTitle => new NotFound(atErrorDetail),
            OwnerCannotLeave.ErrorTitle => new OwnerCannotLeave(atErrorDetail),
            PartSizeMismatch.ErrorTitle => new PartSizeMismatch(atErrorDetail),
            ...
            ReplyTargetNotFound.ErrorTitle => new ReplyTargetNotFound(atErrorDetail),
            ServiceOverloaded.ErrorTitle => new ServiceOverloaded(atErrorDetail),
            TooManyOpenUploads.ErrorTitle => new TooManyOpenUploads(atErrorDetail),
            UnknownFeed.ErrorTitle => new UnknownFeed(atErrorDetail),
            UnknownList.ErrorTitle => new UnknownList(atErrorDetail),
            UnsupportedCollection.ErrorTitle => new UnsupportedCollection(atErrorDetail),
            UnsupportedContentType.ErrorTitle => new UnsupportedContentType(atErrorDetail),
            UploadAborted.ErrorTitle => new UploadAborted(atErrorDetail),
            UploadAlreadyCompleted.ErrorTitle => new UploadAlreadyCompleted(atErrorDetail),
            UploadExpired.ErrorTitle => new UploadExpired(atErrorDetail),
            UploadFailed.ErrorTitle => new UploadFailed(atErrorDetail),
            UploadForbidden.ErrorTitle => new UploadForbidden(atErrorDetail),
            UploadNotFound.ErrorTitle => new UploadNotFound(atErrorDetail),
            UploadNotReady.ErrorTitle => new UploadNotReady(atErrorDetail),
            UserForbidsGroups.ErrorTitle => new UserForbidsGroups(atErrorDetail),
            UserKicked.ErrorTitle => new UserKicked(atErrorDetail),
            VideoTooLarge.ErrorTitle => new VideoTooLarge(atErrorDetail),
            VideoTooLong.ErrorTitle => new VideoTooLong(atErrorDetail),
            _ => atErrorDetail
        };
    }
}
