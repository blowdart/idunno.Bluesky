...
/// <summary>
/// Represents an error that occurs when a conversation is locked and cannot be modified.
/// </summary>
public sealed class ConversationLocked : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="ConversationLocked"/>.
    /// </summary>
    ...
    public ConversationLocked(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "ConvoLocked";
}
