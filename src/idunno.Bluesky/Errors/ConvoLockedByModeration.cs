...
/// <summary>
/// Represents an error indicating that the conversation has been locked by moderation and cannot be unlocked by its members.
/// </summary>
public sealed class ConvoLockedByModeration : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="ConvoLockedByModeration"/>.
    /// </summary>
    ...
    public ConvoLockedByModeration(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "ConvoLockedByModeration";
}
