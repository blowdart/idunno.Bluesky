...
/// <summary>
/// Represents an error that occurs when the daily video or byte allowance, including active reservations, is exhausted.
/// </summary>
public sealed class DailyLimitExceeded : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="DailyLimitExceeded"/>.
    /// </summary>
    ...
    public DailyLimitExceeded(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "DailyLimitExceeded";
}