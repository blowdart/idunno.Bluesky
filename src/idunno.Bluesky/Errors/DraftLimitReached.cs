...
/// <summary>
/// Represents an error that occurs when a user tries to insert a new draft when the limit was already reached.
/// </summary>
public sealed class DraftLimitReached : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="DraftLimitReached"/>.
    /// </summary>
    ...
    public DraftLimitReached(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "DraftLimitReached";
}
