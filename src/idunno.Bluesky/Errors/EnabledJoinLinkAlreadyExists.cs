...
/// <summary>
/// Represents an error indicating that an enabled join link already exists.
/// </summary>
public sealed class EnabledJoinLinkAlreadyExists : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="EnabledJoinLinkAlreadyExists"/>.
    /// </summary>
    ...
    public EnabledJoinLinkAlreadyExists(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "EnabledJoinLinkAlreadyExists";
}