...
/// <summary>
/// Represents an error that occurs when a user requests to join a group where the group admin does not follow the user.
/// </summary>
public sealed class FollowRequired : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="FollowRequired"/>.
    /// </summary>
    ...
    public FollowRequired(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "FollowRequired";
}