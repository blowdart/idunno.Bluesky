...
/// <summary>
/// Represents an error that occurs when the authenticated user does not have the required role to perform an action.
/// </summary>
public sealed class InsufficientRole : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="InsufficientRole"/>.
    /// </summary>
    ...
    public InsufficientRole(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "InsufficientRole";
}