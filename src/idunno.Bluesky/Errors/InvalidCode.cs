...
/// <summary>
/// Represents an error that occurs when a user requests to join a group with an invalid join code.
/// </summary>
public sealed class InvalidCode : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="InvalidCode"/>.
    /// </summary>
    ...
    public InvalidCode(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "InvalidCode";
}
