...
/// <summary>
/// Represents an error indicating that the conversation is invalid.
/// </summary>
public sealed class InvalidConversation : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="InvalidConversation"/>.
    /// </summary>
    ...
    public InvalidConversation(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "InvalidConvo";
}