...
/// <summary>
/// Represents an error indicating that the join request referred to is not valid.
/// </summary>
public sealed class InvalidJoinRequest : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="InvalidJoinRequest"/>.
    /// </summary>
    ...
    public InvalidJoinRequest(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "InvalidJoinRequest";
}
