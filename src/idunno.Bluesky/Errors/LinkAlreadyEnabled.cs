...
/// <summary>
/// Represents an error indicating that the join link is already enabled.
/// </summary>
public sealed class LinkAlreadyEnabled : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="LinkAlreadyEnabled"/>.
    /// </summary>
    ...
    public LinkAlreadyEnabled(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "LinkAlreadyEnabled";
}
