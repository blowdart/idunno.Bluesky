...
/// <summary>
/// Represents an error indicating that the member limit has been reached for a group conversation.
/// </summary>
public sealed class MemberLimitReached : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="MemberLimitReached"/>.
    /// </summary>
    ...
    public MemberLimitReached(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "MemberLimitReached";
}