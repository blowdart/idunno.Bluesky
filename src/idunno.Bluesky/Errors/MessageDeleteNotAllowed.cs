...
/// </summary>
public sealed class MessageDeleteNotAllowed : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="MessageDeleteNotAllowed"/>.
    /// </summary>
    ...
    public MessageDeleteNotAllowed(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "MessageDeleteNotAllowed";
}