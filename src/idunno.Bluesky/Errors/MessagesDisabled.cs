...
/// <summary>
/// Represents an error that occurs when a user attempts to send messages to another user whose messaging is disabled.
/// </summary>
public sealed class MessagesDisabled : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="MessagesDisabled"/>.
    /// </summary>
    ...
    public MessagesDisabled(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "MessagesDisabled";
}