...
/// <summary>
/// Represents an error that occurs when a new account attempts to create a group, but is not allowed to do so.
/// </summary>
public sealed class NewAccountCannotCreateGroup : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="NewAccountCannotCreateGroup"/>.
    /// </summary>
    ...
    public NewAccountCannotCreateGroup(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "NewAccountCannotCreateGroup";
}
