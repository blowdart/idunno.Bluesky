...
/// <summary>
/// Represents an error indicating that an operation on the join link for a conversation failed because there is no join link.
/// </summary>
public sealed class NoJoinLink : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="NoJoinLink"/>.
    /// </summary>
    ...
    public NoJoinLink(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "NoJoinLink";
}