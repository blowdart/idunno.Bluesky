...
/// <summary>
/// Represents an error indicating that the sender is not followed by the recipient.
/// </summary>
public sealed class NotFollowedBySender : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="NotFollowedBySender"/>.
    /// </summary>
    ...
    public NotFollowedBySender(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "NotFollowedBySender";
}