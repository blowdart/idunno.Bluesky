...
/// <summary>
/// Represents an error indicating that the requested thread could not be found.
/// </summary>
public sealed class NotFound : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="NotFound"/>.
    /// </summary>
    ...
    public NotFound(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "NotFound";
}
