...
/// <summary>
/// Indicates the Content-Length does not exactly match the expected size for this part.
/// </summary>
public sealed class PartSizeMismatch : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="PartSizeMismatch"/>.
    /// </summary>
    ...
    public PartSizeMismatch(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "PartSizeMismatch";
}