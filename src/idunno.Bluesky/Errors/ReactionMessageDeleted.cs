...
/// </summary>
public sealed class ReactionMessageDeleted : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="ReactionMessageDeleted"/>.
    /// </summary>
    ...
    public ReactionMessageDeleted(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "ReactionMessageDeleted";
}
