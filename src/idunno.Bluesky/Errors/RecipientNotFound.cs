...
/// <summary>
/// Represents an error that occurs when a recipient is not found in a conversation.
/// </summary>
public sealed class RecipientNotFound : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="RecipientNotFound"/>.
    /// </summary>
    ...
    public RecipientNotFound(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "RecipientNotFound";
}