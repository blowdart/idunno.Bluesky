...
/// <summary>
/// Represents an error indicating that the message a reply was addressed to could not be found.
/// </summary>
public sealed class ReplyTargetNotFound : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="ReplyTargetNotFound"/>.
    /// </summary>
    ...
    public ReplyTargetNotFound(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "ReplyTargetNotFound";
}
