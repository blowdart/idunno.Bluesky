...
/// <summary>
/// Represents an error that occurs when the service is draining, at capacity, or temporarily unable to create the multipart upload.
/// </summary>
public sealed class ServiceOverloaded : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="ServiceOverloaded"/>.
    /// </summary>
    ...
    public ServiceOverloaded(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "ServiceOverloaded";
}