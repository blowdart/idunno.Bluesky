...
/// <summary>
/// Represents an error that occurs when the account has reached its open multipart upload limit.
/// </summary>
public sealed class TooManyOpenUploads : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="TooManyOpenUploads"/>.
    /// </summary>
    ...
    public TooManyOpenUploads(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "TooManyOpenUploads";
}