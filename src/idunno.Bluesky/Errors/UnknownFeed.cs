...
/// <summary>
/// Represents an error indicating that the requested feed generator is not known to the service.
/// </summary>
public sealed class UnknownFeed : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="UnknownFeed"/>.
    /// </summary>
    ...
    public UnknownFeed(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "UnknownFeed";
}
