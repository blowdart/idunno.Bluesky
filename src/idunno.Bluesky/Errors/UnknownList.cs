...
/// <summary>
/// Represents an error indicating that the requested list is not known to the service.
/// </summary>
public sealed class UnknownList : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="UnknownList"/>.
    /// </summary>
    ...
    public UnknownList(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "UnknownList";
}
