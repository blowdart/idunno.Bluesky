...
{
    /// <summary>
    /// Creates a new instance of the <see cref="UploadAborted"/>.
    /// </summary>
    ...
    public UploadAborted(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "UploadAborted";
}