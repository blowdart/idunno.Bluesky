...
/// <summary>
/// Represents an error that occurs when the session is known to have already completed.
/// </summary>
public sealed class UploadAlreadyCompleted : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="UploadAlreadyCompleted"/>.
    /// </summary>
    ...
    public UploadAlreadyCompleted(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "UploadAlreadyCompleted";
}