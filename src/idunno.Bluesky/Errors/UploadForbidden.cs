...
/// <summary>
/// Represents an error that occurs when the account is not permitted to upload video.
/// </summary>
public sealed class UploadForbidden : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="UploadForbidden"/>.
    /// </summary>
    ...
    public UploadForbidden(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "UploadForbidden";
}