...
/// <summary>
/// Represents an error that occurs when the multi-part video upload job ID is unknown or aged out of retention;
/// </summary>
public sealed class UploadNotFound : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="UploadNotFound"/>.
    /// </summary>
    ...
    public UploadNotFound(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "UploadNotFound";
}