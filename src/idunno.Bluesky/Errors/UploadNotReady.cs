...
/// </summary>
public sealed class UploadNotReady : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="UploadNotReady"/>.
    /// </summary>
    ...
    public UploadNotReady(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "UploadNotReady";
}