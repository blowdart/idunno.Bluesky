...
/// <summary>
/// Represents an error that occurs when a user requests to join a group they have already been kicked from.
/// </summary>
public sealed class UserKicked : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="UserKicked"/>.
    /// </summary>
    ...
    public UserKicked(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "UserKicked";
}