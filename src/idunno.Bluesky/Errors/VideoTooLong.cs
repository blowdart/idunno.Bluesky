...
/// <summary>
/// Represents an error that occurs when a video is too long during multipart video uploads, where the advisory declared duration exceeds the limit.
/// </summary>
public sealed class VideoTooLong : BlueskyError
{
    /// <summary>
    /// Creates a new instance of the <see cref="VideoTooLong"/>.
    /// </summary>
    ...
    public VideoTooLong(AtErrorDetail atErrorDetail) : base(atErrorDetail)
    {
    ...
    internal const string ErrorTitle = "VideoTooLong";
}