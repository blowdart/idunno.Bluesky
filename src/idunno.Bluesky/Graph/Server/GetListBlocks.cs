...
public static partial class BlueskyServer
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        BlueskyHttpClient<GetListBlocksResponse> client = new(AppViewProxy, loggerFactory) { MaximumResponseSize = maximumResponseSize };
        AtProtoHttpResult<GetListBlocksResponse> response = await client.Get(
            service,
            $"/xrpc/app.bsky.graph.getListBlocks?{queryString}",
