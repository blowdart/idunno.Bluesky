...
public static partial class BlueskyServer
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        BlueskyHttpClient<GetStarterPackResponse> client = new(AppViewProxy, loggerFactory) { MaximumResponseSize = maximumResponseSize };
        AtProtoHttpResult<GetStarterPackResponse> response = await client.Get(
            service,
            $"/xrpc/app.bsky.graph.getStarterPack?starterPack={Uri.EscapeDataString(uri.ToString())}",
