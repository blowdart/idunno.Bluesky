...
public static partial class BlueskyServer
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        BlueskyHttpClient<SuggestedActors> client = new(AppViewProxy, loggerFactory) { MaximumResponseSize = maximumResponseSize };
        AtProtoHttpResult<SuggestedActors> response = await client.Get(
            service,
            $"/xrpc/app.bsky.graph.getSuggestedFollowsByActor?actor={Uri.EscapeDataString(actor.ToString())}",
