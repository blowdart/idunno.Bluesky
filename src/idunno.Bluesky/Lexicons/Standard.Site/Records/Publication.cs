...
public record Publication : Publication<Preferences>
{
    ...
    /// <param name="name">Name of the publication. Required, must be &lt; 1280 UTF-8 bytes and &lt; 128 graphemes.</param>
    /// <param name="icon">Optional square image to identify the publication. Should be at least 256x256 and &lt; 1Mb in size.</param>
    /// <param name="description">Optional brief description of the publication. If specified must be &lt; 3000 UTF-8 bytes and &lt; 300 graphemes.</param>
...
public record Publication<T> : AtProtoRecord where T : Preferences
{
    ...
    public Publication(Uri url, string name, Blob? icon = null, string? description = null, BasicTheme? basicTheme = null, T? preferences = null)
    {
        ...
        ArgumentOutOfRangeException.ThrowIfGreaterThan(name.GetUtf8Length(), 1280);
        ...
        {
            ArgumentOutOfRangeException.ThrowIfGreaterThan(description.GetUtf8Length(), 3000);
