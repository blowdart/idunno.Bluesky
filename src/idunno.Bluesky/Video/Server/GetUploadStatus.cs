...
{
    /// <summary>
    /// Get the authoritative status of the upload phase of a multi part video upload.
    /// </summary>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        BlueskyHttpClient<GetUploadStatusResponse> client = new(AppViewProxy, loggerFactory);
        ...
        {
            result = new UploadStatus(response.Result);
        }
